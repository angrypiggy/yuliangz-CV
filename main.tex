    ...
    \resumeSubheading
      ...
      {Machine Learning Engineer}{Jan 2022 \textbf{--} Present}
        \resumeItemListStart
            ...
            \resumeItem{Optimized the pixel-precise pencil tip localization algorithms in C++ based on mathematical models, addressing hardware noise challenges and \textbf{improving the prediction accuracy by 47\%} }
            ...
            \resumeItem{Impacted a \textbf{SVP-level product shipping decision} by deriving statistical insights of algorithm performance, helping discover user experience risks and shield the company from a potential \textbf{\$5B+ loss}}
