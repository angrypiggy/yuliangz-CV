...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {M.Sc. in Electrical and Computer Engineering (Computer Vision track);   \textbf{GPA: 4.00/4.00}}{Sep 2019 \textbf{--} Dec 2021}
      {M.Sc. in Mechanical Engineering;
      \textbf{GPA: 4.00/4.00}}{}
        \resumeSubHeadingListStart
        \small{\item{
            \textbf{Relevant coursework:} Machine Learning, Deep Learning for Computer Vision, Unsupervised Visual Learning}}
    ...
    \resumeSubheading
      ...
      {B.En. in Vehicle Engineering;   \textbf{GPA: 4.00/4.00(Major), 3.60/4.00(Overall)}}{Sep 2015 \textbf{--} Jun 2019}
      \resumeSubHeadingListStart
        \small{\item{
            \textbf{Award:} Lingshui Academic Scholarship (Top 10\% of 500)}}
        \resumeSubHeadingListEnd
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Languages:}{ C/C++, C\#, Python, Julia, Java, JavaScript, CSS, HTML, MATLAB, Unix Shell, Git} \\ \vspace{3pt}
        
        \textbf{Deep Learning:}{ PyTorch, TensorFlow, ResNet, CNN, RNN, LSTM, Transformer, Regularization, Attention, GAN} \\ \vspace{3pt}
        
        \textbf{Robotics:}{ ROS, Object Detection, SLAM, Reinforcement Learning, Path Planning, Control, SolidWorks} \\ \vspace{3pt}
